# Model H — LP-funded CPMM

Auto-built by `simulator_h.py`. Alternative to G — keeps F's locked-reward and copy-trade immunity while killing F's inflation, by replacing house-supplied virtual liquidity with user-supplied liquidity earning fees.
...
| Later YES buyers | F | H (LP=20) | H (LP=50) |
|---|---|---|---|
| 0 |   +9.17 |   +6.38 |   +7.99 |
| 5 |   +9.17 |   +6.38 |   +7.99 |
| 20 |   +9.17 |   +6.38 |   +7.99 |
