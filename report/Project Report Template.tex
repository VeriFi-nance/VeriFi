...
\textit{Note: Formal UML use case diagrams illustrating actor relationships will be included in the final report.}
...
\textit{Note: A formal Entity-Relationship (ER) diagram showing the above models and their relationships will be included in the final report.}
...
\textit{Note: Formal sequence diagrams and activity diagrams (BPMN) for the above flows will be included in the final report.}
...
\textit{Note: Formal class diagrams and module dependency diagrams will be included in the final report.}
